  ...
  return (
    <div ref={heroRef} className={`relative h-screen flex items-center container mx-auto fade ${styles.heroHolder}`}>
      <div className="relative text-left py-8">
        <p className={`font-normal mb-5 text-base lg:text-lg ${fonts.inter.className}`}>Hi, I&#39;m </p>
          <h1 className={`font-bold mb-4 max-w-7xl flex flex-col ${fonts.poppins.className}`}>
        ...
        <p className={`mb-5 text-gray-500 dark:text-gray-400 text-sm lg:text-base ${fonts.inter.className}`}>I’m a web developer specializing in building (and occasionally designing) <br/> exceptional digital experiences.</p>
